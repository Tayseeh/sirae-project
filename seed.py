...
with app.app_context():
    ...
    # ─────────────────────────────────────────
    usuarios_data = [
        dict(email='admin@sirae.com',      nome='Administrador',          perfil='admin',
             cargo='Analista de TI',        telefone='(16) 3301-1000',     ramal='2000', senha='admin123'),
        dict(email='ana.lima@sirae.com',   nome='Ana Lima',               perfil='atendente',
             cargo='Atendente do Setor de Apoio', telefone='(16) 99101-1111', ramal='2011', senha='123456'),
        dict(email='carlos.m@sirae.com',   nome='Carlos Menezes',         perfil='atendente',
             cargo='Assistente Estudantil', telefone='(16) 99202-2222',    ramal='2012', senha='123456'),
        dict(email='patricia@sirae.com',   nome='Patrícia Souza',         perfil='atendente',
             cargo='Atendente do Setor de Apoio', telefone='(16) 99303-3333', ramal='2013', senha='123456'),
        dict(email='fernanda.p@sirae.com', nome='Fernanda Prado',         perfil='pedagogia',
             cargo='Pedagoga',              telefone='(16) 99404-4444',    ramal='2021', senha='123456'),
        dict(email='rodrigo.b@sirae.com',  nome='Rodrigo Bastos',         perfil='pedagogia',
             cargo='Pedagogo',              telefone='(16) 99505-5555',    ramal='2022', senha='123456'),
        dict(email='marcos.r@sirae.com',   nome='Marcos Ribeiro',         perfil='coordenacao',
             cargo='Coordenador Pedagógico', telefone='(16) 99606-6666',   ramal='2031', senha='123456'),
        dict(email='juliana.c@sirae.com',  nome='Juliana Cardoso',        perfil='coordenacao',
    ...
    fernanda = usuarios['fernanda.p@sirae.com']
    rodrigo  = usuarios['rodrigo.b@sirae.com']
    ...
    # OCORRÊNCIAS
    # ─────────────────────────────────────────
    def dp(dias): return datetime.utcnow() - timedelta(days=dias)
    ...
    def criar(aluno, tipo, status, criado, responsavel, descricao, data_criacao, logs, data_enc=None):
        ...
        for acao, usuario, desc, dias in logs:
            db.session.add(LogAuditoria(
                ...
                data_hora=datetime.utcnow() - timedelta(days=dias)
            ))
        return o
    ...
    print("  fernanda.p@sirae.com  / 123456    → Pedagogo")
    print("  rodrigo.b@sirae.com   / 123456    → Pedagogo")
